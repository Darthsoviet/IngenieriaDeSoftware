 ...
 * @author silve
 */
public class Samgung extends Celular{

    public Samgung() {
    }

    public Samgung(double pantalla, String so, String procesador, String alamacenamiento, String camaraFrontal, String camaraTrasera, int ram, String bateria) {
